...
if(empty($action)){  // Verifica se usu?rio for?ou entrada ou veio de links externos
...
//	}
	...
	if(count($err)>0){
        ...
        $rsTableStatus = mysqli_fetch_array(mysqli_query("SHOW TABLE STATUS LIKE 'lista_email'"));
...
if($action == "saveUsuario"){
    ...
    if (empty($_POST['loginId'])){
        $err[] = 'Informe o Login ID de acesso ao sistema do usu?rio.';
    } else {
